    ...
    <footer className="site-footer">
      ...
      <nav aria-label="Footer navigation">
        ...
        <div>
          ...
          <a className="footer-social-link x" href="https://x.com/budolph_" rel="noreferrer" target="_blank">
            <svg aria-hidden="true" className="footer-social-icon" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.451-6.231Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z" />
            </svg>
            X
          </a>
          <a className="footer-social-link facebook" href="https://www.facebook.com/profile.php?id=61590670526100" rel="noreferrer" target="_blank">
            <svg aria-hidden="true" className="footer-social-icon" viewBox="0 0 24 24">
